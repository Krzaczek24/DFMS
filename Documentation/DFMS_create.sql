...
START TRANSACTION;
USE `DFMS`;
INSERT INTO `DFMS`.`form.validation_rule_definition` (`id`, `add_login`, `add_date`, `modif_login`, `modif_date`, `active`, `title`, `validation_type_id`, `default_value`, `default_message`, `editable_value`, `editable_message`, `global`) VALUES (DEFAULT, 'CREATE_SCRIPT', DEFAULT, NULL, NULL, DEFAULT, 'Pole wymagane', 1, NULL, 'Pole obowiązkowe', 0, 1, 1);
